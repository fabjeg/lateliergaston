...
function About() {
  ...
  return (
    <div className="about">
      <SEO
        title="À Propos"
        description="Découvrez l'histoire de L'Atelier Gaston, artisan brodeur passionné. Notre mission : créer des œuvres uniques alliant photographie et broderie artisanale."
        url="/about"
      />
